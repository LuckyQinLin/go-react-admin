...
func TestDebugPrintRoutes(t *testing.T) {
	re := captureOutput(t, func() {
		SetMode(DebugMode)
		debugPrintRoute(nil, "GET", "/path/to/route/:param", HandlersChain{func(c *Context) {}, handlerNameTest})
		SetMode(TestMode)
	})
...
func TestDebugPrintRouteFunc(t *testing.T) {
	...
	re := captureOutput(t, func() {
		SetMode(DebugMode)
		debugPrintRoute(nil, "GET", "/path/to/route/:param1/:param2", HandlersChain{func(c *Context) {}, handlerNameTest})
		SetMode(TestMode)
	})
