...
type Operate struct {
	...
	OperName      string    `gorm:"column:oper_name;size:50;default:'';comment:模块标题" json:"operName"`
	DeptName      string    `gorm:"column:dept_name;size:50;default:'';comment:模块标题" json:"deptName"`
	OperUrl       string    `gorm:"column:oper_url;size:255;default:'';comment:模块标题" json:"operUrl"`
	OperIp        string    `gorm:"column:oper_ip;size:128;default:'';comment:模块标题" json:"operIp"`
	OperLocation  string    `gorm:"column:oper_location;size:255;default:'';comment:模块标题" json:"operLocation"`
	OperParam     string    `gorm:"column:oper_param;size:2000;default:'';comment:模块标题" json:"operParam"`
